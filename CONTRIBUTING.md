# Contributing to CLOC History Analyzer
...
2. Clone your fork: `git clone https://github.com/yourusername/cloc-history-analyzer.git`
...
- Put detailed guides in docs/ folder
...
Thank you for contributing to CLOC History Analyzer! 🎉
